...
```bash
    npm install https://player.si9n.io/npm/si9n-sdk-1.5.0.tgz
```
...
```javascript
    ...
    si9n.env.backgroundApp   // is running as a background app
    si9n.env.inCalendar      // is running in a calendar
    si9n.env.inInterrupt     // is running in an interrupt
    si9n.env.inLayout        // is running in a layout
    si9n.env.inPlaylist      // is running in a playlist
    si9n.env.inMessage       // is a message
    ...
    si9n.focus() // bring the si9n window to the top and focus
